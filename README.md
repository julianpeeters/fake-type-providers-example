An example SBT project which uses Travis Brown's strategy for emulating Type Macros with fake type providers (http://meta.plasm.us/posts/2013/07/11/fake-type-providers-part-2/).
